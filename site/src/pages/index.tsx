    ...
    <header className={clsx('hero', styles.heroBanner)}>
      <div className="container">
        <img
          ...
          alt="Mindful Software Workflows Logo"
        />
...
export default function Home(): JSX.Element {
  ...
  return (
    <Layout
      description={`The official documentation site for Mindful Software Workflows. ${siteConfig.tagline}`}
    >
      <HomepageHeader />
      <main>
        <HomepageBlogs />
      ...
      <div className={styles.width}>
        ...
        <div className={styles.column}>
          <div className={styles.content}>
            ...
            <p>A guide for using Mindful Software Workflows in your projects.</p>
            <Link
              style={{ fontWeight: 'bold' }}
              to="https://mindfulsoftware.com/blog/configuring-workflows-for-your-flutter-projects"
            >
              Read the Blog &gt;
            </Link>
          </div>
